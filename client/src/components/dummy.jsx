...
const chatImages = [
  "https://www.tailwindtap.com/assets/admin/dashboard/user10.png",
  "https://www.tailwindtap.com/assets/admin/dashboard/user10.png",
  "https://www.tailwindtap.com/assets/admin/dashboard/user12.png",
  "https://www.tailwindtap.com/assets/admin/dashboard/user13.png",
  "https://www.tailwindtap.com/assets/admin/dashboard/user14.png",
];
const productData = [
  {
    product: "Apple Macbook Pro...",
    ...
    revenue: "$51,440",
    rating: "4.82",
    image: "https://www.tailwindtap.com/assets/admin/dashboard/mac.png",
  },
  {
    product: "iBox iPhone 14Pro...",
    price: "120",
...
const messages = [
  ...
  {
    image: "https://www.tailwindtap.com/assets/admin/dashboard/user5.png",
    name: "Huda Mccall",
    message: "Can you deliver my order...",
    alt: "user4",
  },
  {
    image: "https://www.tailwindtap.com/assets/admin/dashboard/user4.png",
    name: "Ethel Nicholson",
    message: "Can you deliver my order...",
    alt: "user5",
  },
  {
    image: "https://www.tailwindtap.com/assets/admin/dashboard/user6.png",
    name: "Oliver Clark",
    message: "Very quick and easy...",
    alt: "user6",
  },
  {
    image: "https://www.tailwindtap.com/assets/admin/dashboard/user7.png",
    name: "Nettie Barnett",
    message: "Great service by Dominik... ",
    alt: "user7",
  },
  {
    image: "https://www.tailwindtap.com/assets/admin/dashboard/user8.png",
    name: "Junaid Horn",
    message: "Just come back to home...",
    alt: "user8",
  },
  {
    image: "https://www.tailwindtap.com/assets/admin/dashboard/user9.png",
    name: "Angus Thomson",
                        ...
                        <td className="py-4 px-1.5 text-sm font-normal text-[#637381] rounded-r-lg">
                          <div className="relative flex gap-2 items-center">
                            <div className="w-[10px] h-[10px]">
                              <img
                                src="https://www.tailwindtap.com/assets/admin/dashboard/star.svg"
                                alt="star"
                ...
                <div className="flex flex-col gap-2.5">
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="flex items-start gap-3">
                      <div className="max-h-6 max-w-[22px]">
                        <img
                          src="https://www.tailwindtap.com/assets/admin/dashboard/user10.png"
                          alt="user"
                          className="min-w-[22px] min-h-[22px]"
                        />
                      </div>
                  ...
                  <div className="mt-3.5 w-full flex gap-3.5">
                    ...
                    <div className="flex items-center gap-3">
                      <img
                        src="	https://www.tailwindtap.com/assets/admin/dashboard/mic.svg"
                        alt="mic"
                        className="min-w-[14px] min-h-[14px] cursor-pointer"
                      />
                      <img
                        src="https://www.tailwindtap.com/assets/admin/dashboard/dots.svg"
                        alt="dots"
